    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": f"""You are a web data extractor. Extract structured data from this webpage content:
{page_text}
Return as JSON with: Title, Headings, Summary, Important Links, Tables, Contact info"""
                }
            ]
        )
